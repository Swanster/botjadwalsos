...
from core.database import (
    ...
    get_all_settings, get_setting, set_setting, init_default_settings,
...
def create_app():
    ...
    def settings():
        if request.method == 'POST':
            ...
            kuota_infra = request.form.get('kuota_infra', '2')
            kuota_ce = request.form.get('kuota_ce', '1')
            max_hari_infra = request.form.get('max_hari_infra', '10')
            max_hari_ce = request.form.get('max_hari_ce', '31')
            
            set_setting('kuota_infra', kuota_infra, 'Jumlah orang INFRA per hari')
            set_setting('kuota_ce', kuota_ce, 'Jumlah orang CE per hari')
            set_setting('max_hari_infra', max_hari_infra, 'Maksimal hari standby per bulan untuk INFRA')
            set_setting('max_hari_ce', max_hari_ce, 'Maksimal hari standby per bulan untuk CE')
    ...
    def schedules():
        ...
        for j in jadwal_list:
            ...
            jadwal_per_tanggal[tanggal].append(dict(j))
